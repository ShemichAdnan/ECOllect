...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        {
            var existingUser = connection.Table<User>().FirstOrDefault(u => u.Email == user.Email);
        ...
        var actions = new List<CommunityAction>
        {
            new CommunityAction {
                Id = 1,
        ...
        {
            var existingAction = connection.Table<CommunityAction>().FirstOrDefault(a => a.Id == action.Id);
